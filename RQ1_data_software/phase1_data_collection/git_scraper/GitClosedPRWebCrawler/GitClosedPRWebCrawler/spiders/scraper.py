...
from GitClosedPRWebCrawler.items import GitItem
import csv
import json
...
class GitSpider(CrawlSpider):
    ...
    git_pr_urls = [x + "?q=is%3Apr+is%3Aclosed" for x in git_urls]
    #print(git_issue_urls)
    start_urls = ['https://github.com/ipa320/schunk_robots/pulls?q=is%3Apr+is%3Aclosed']
