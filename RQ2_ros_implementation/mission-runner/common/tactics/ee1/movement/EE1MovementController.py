...
class EE1MovementController(EE1LimitableMovement, metaclass=Singleton):
    # Controllers
    ...
    # Implementation of the EE1 Tactic
    ...
    def turn_full_rotation(self, direction: RotationDirection) -> None:
        print("--- EE1: Waiting 5 seconds before rotation ---")
        self.limit_straight_line_movement() # Agreed upon change, sleep for 5 seconds before continuing rotation
        # Rationale: EE1 limits straight-line movement by waiting 5 seconds.
